...
public class FileService {
	...
	public static String saveFile(MultipartFile upload, String uploadPath) {
		...
		//1. 저장할 파일명 뒤에 을 오늘 날짜의 년월일로 생성
		// SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddhhmmss");
		
		//2. 날짜나 랜덤값을 붙여 저장할 파일명을 작성한다. 랜덤 데이터 크기 36
		...
		// 점의 위치를 반환하는 것 file명.확장자명 . 확장자가 없으면 -1을 리턴함
		...
		//확장자가 있는 경우
			...
			//file명 + "_" + 난수 + ext; -> song_9dfsdfee.hwp 
		}
