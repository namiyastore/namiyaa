...
<h1 style="color: white; font-family: 'VT323';">Sended message</h1>
<form action="mypageSendMsg" name="form" method="post">
<input type="hidden" name="copy" value="1">
<table style="margin-bottom: 10px;">
	<tr>
		<td class="menu"><b>보낸사람</b></td>
		<td class="content"><input type="text" id="writerid" name="writerid" value="${sendedmessage.writerid}" readonly="readonly" style="outline: none; border: none;"></td>
	</tr>
	<tr>
		<td class="menu"><b>받은사람</b></td>
		<td class="content"><input type="text" id="userid" name="userid" value="${sendedmessage.userid}" readonly="readonly" style="outline: none; border: none;"></td>
	</tr>
	<tr>
		<td class="menu"><b>제목</b></td>
		<td class="content"><input name="msg_title" id="msg_title" value="${sendedmessage.msg_title}" readonly="readonly" style="width: 230px; outline: none;"></td>
	</tr>
	<tr>
		<td colspan="2" class="content"><textarea cols="50" rows="10" name="msg_content" id="msg_content" readonly="readonly" style="resize: none; outline: none;">${sendedmessage.msg_content}</textarea></td>
	</tr>
</table>
</form>
