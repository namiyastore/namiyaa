	...
	<div id="scroll" style="float:left; width: 1073px; height:545px; overflow-y:auto; overflow-x:hidden; border-radius: 25px; background-color: white;">
			<div id="tradeform">
				<table>
					...
					<tr>
						<td class="menu" colspan="2"><b><spring:message code="talentView.status" /></b></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" class="menu"><b><spring:message code="talentView.title" /></b></td>
					</tr>
					<tr>
						<td colspan="2" class="scontent"><input type="text" class="ins" id="title" name="title" value="${board.title}" readonly="readonly"></td>
					</tr>
					<tr>
						<td colspan="2" class="menu"><b><spring:message code="talentView.content" /></b></td>
					</tr>
					<tr>
						<td colspan="2">
							<div id="content" style="width:950px;" >
								...
								<textarea rows="15" cols="150" style="resize:none; outline: none; border: none; background-color: #fcfbf9; padding-left: 10px; font-family: 'Raleway', 'Nanum Gothic', 'Noto Sans Japanese';" readonly="readonly">${board.content}</textarea>
								</c:if>	
					...
					<tr>
						<td colspan="2" class="menu"><b><spring:message code="talentView.productinfo" /></b></td>
					</tr>
					<tr>
						<td class="sort"><b><spring:message code="talentView.sort" /></b></td>
						<td class="scontent">
					...
					<tr>
						<td class="sort"><b><spring:message code="talentView.name" /></b></td>
