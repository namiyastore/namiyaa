					...
					<tr>
						<td colspan="2">
							<div id="content" style="width:950px;" >
								...
								<textarea rows="15" cols="150" style="resize:none; outline: none; border: none; background-color: #fcfbf9; padding-left: 10px; font-family: 'Raleway', 'Nanum Gothic';" readonly="readonly">${board.content}</textarea>
								</c:if>	
