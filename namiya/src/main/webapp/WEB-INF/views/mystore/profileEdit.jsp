...
#gnb.gnb_one_flat .gnb_login_li .gnb_btn_login .gnb_txt {color: #777;}</style>
...
<script type="text/javascript">
    ...
    function showAvatarWindow() {
        var avatarUrl = "http://avatar.nid.naver.com?lang=ko_KR&key=igCdbdw1SGiqFAK2&url=viewModifyProfile&mode=1";
...
<div id="wrap">
	...
	<div id="container" style="height: 647px;">
		<!-- CONTENTS -->
		<div id="content">
    <div class="c_header">
        <h2>프로필 수정</h2>
        <p class="contxt">대표 프로필과 별명을 수정 하실 수 있습니다.</p>
    </div>
                    ...
                    <td>
                        <div class="tdcell">
                            <p class="contxt_webctrl nickname">
                                <input type="text" name="nickname" id="inpNickname" value="꼬꼬닭" style="width:254px" onclick="clickcr(this,'prf.nick','','',event);">
