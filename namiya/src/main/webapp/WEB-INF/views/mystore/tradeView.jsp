...
<div id="wrapper" align="center">
	<div id="scroll" style="float:left; width: 1073px; height:545px; overflow-y:auto; overflow-x:hidden; border-radius: 25px; background-color: white;">
			<div id="tradeform">
				...
				<br/>
				<img src="resources/images/board.png" style="width:60px; height:40px;" onclick="trade()">
				<img src="resources/images/update.png" style="width:60px; height:40px;" onclick="tradeUpdate(${board.boardnum})">
