...
function want(boardnum, userid) {
	...
	function tradeUpdate(boardnum) {
		location.href="tradeUpdate?boardnum="+boardnum;
	}
				...
				<table>
					<tr>
						<td colspan="2" id="boardname">
							<h1 align="center"><b>Exchange Things</b></h1>
							<hr/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="menu" colspan="2"><b><spring:message code="tradeView.status" /></b></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" class="menu"><b><spring:message code="tradeView.title" /></b></td>
					</tr>
					<tr>
						<td colspan="2" class="scontent"><input type="text" class="ins" id="title" name="title" value="${board.title}" readonly="readonly"></td>
					</tr>
					<tr>
						<td colspan="2" class="menu"><b><spring:message code="tradeView.content" /></b></td>
					</tr>
					<tr>
						<td colspan="2">
					...
					<tr>
						<td colspan="2" class="menu"><b><spring:message code="tradeView.productinfo" /></b></td>
					</tr>
					<tr>
						<td class="sort"><b><spring:message code="tradeView.sort" /></b></td>
						<td class="scontent">
					...
					<tr>
						<td class="sort"><b><spring:message code="tradeView.name" /></b></td>
