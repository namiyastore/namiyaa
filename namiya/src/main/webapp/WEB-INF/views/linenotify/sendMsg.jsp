...
<table style="margin-bottom: 10px;">
	<tr>
		...
		<td class="content"><input type="text" id="writerid" name="writerid" value="${userid}" readonly="readonly" style="outline: none; border: none;"></td>
	</tr>
	<tr>
		<td class="menu"><b>받는사람</b></td>
		<td class="content"><input type="text" id="userid" name="userid" value="${senderid}" readonly="readonly" style="outline: none; border: none;"></td>
	</tr>
	<tr>
