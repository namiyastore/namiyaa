...
<form action="join_form" id="form" name="form" method="post">
                ...
                <div class="join_row join_mobile" id="mobDiv">
          	    ...
          	    <div class="KorAddress">
 					...
 					<input type="hidden" name="currentPage" value="1"/>				<!-- 요청 변수 설정 (현재 페이지. currentPage : n > 0) -->
  					...
  					<input type="text" id="addr" name="addr" value="" readonly="readonly" size="90"/>
  					<input type="text" id="zip" name="zip" value="" readonly="readonly" size="5"/>
  					<input type="text" id="detailAddr" name="detailAddr" value="" placeholder="상세주소입력" size="10"/>
           		</div> 
          		<div>
