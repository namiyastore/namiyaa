...
<form action="edit_form" id="form" name="form" method="post" class="login100-form">
    ...
    <!-- container -->
            ...
            <div class="join_content">
                ...
                <div class="row_group">
                    ...
                    <div>
                        <h6 style="color: #999999" class="join_title">생년월일</h6>
                            ...
                            <div style="display: inline-block;" class="wrap-input10 validate-input">
								<input type="text" class="input1" value="${member.birthday}" maxlength="8" readonly="readonly">
                            </div>
                    </div>
                    ...
                    <div class="join_row join_sex">
                        ...
                        <div style="display: inline-block;" class="wrap-input10 validate-input">
								<input type="text" class="input1" value="${member.gender}" maxlength="8" readonly="readonly">
                        </div>
                    </div>
       ...
       <div class="KorAddress">
	        ...
	        <div id="callBackDiv">
	        	<div style="display: inline-block" class="wrap-input100 validate-input">
	        		<input type="text" id="zipcode" name="zipcode" class="input100" maxlength="16" value="${member.zipcode}" readonly="readonly">
					<input type="text" id="fullAddr" name="fullAddr" class="input100" maxlength="16" value="${member.fullAddr}" readonly="readonly">
                </div>
